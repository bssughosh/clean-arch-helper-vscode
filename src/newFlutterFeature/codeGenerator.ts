...
import { getFlutterControllerCodeTemplate, getFlutterDeviceViewCodeTemplate, getFlutterPresenterCodeTemplate, getFlutterStateMachineCodeTemplate, getFlutterViewCodeTemplate } from "../code_generator_templates/flutter/flutter_presentation_layer_template";
...
function generatePresentationLayerCode(
	...
	for (let state in FlutterState) {
		writeDataToFile(
			...
			getFlutterDeviceViewCodeTemplate(FlutterState[state as keyof typeof FlutterState], DeviceType.Mobile)
		);
	}
	...
	for (let state in FlutterState) {
		writeDataToFile(
			...
			getFlutterDeviceViewCodeTemplate(FlutterState[state as keyof typeof FlutterState], DeviceType.Web)
		);
	}
}
