import {
  getTSDataLayerFirestoreWrapperCodeTemplate,
  getTSDataLayerRepositoryCodeTemplate,
} from "../code_generator_templates/ts/ts_data_layer_template";
import { getTSDomainLayerCodeTemplate } from "../code_generator_templates/ts/ts_domain_layer_template";
import {
  getTSDeserializerCodeTemplate,
  getTSOrchestratorCodeTemplate,
  getTSSerializerCodeTemplate,
} from "../code_generator_templates/ts/ts_gateway_layer_template";
