...
export const newTSFeatureOrchestrator = async (uri: Uri) => {
    ...
    const rawFeatureType: string | undefined = await promptForOptionsInput([TSFeatureType.NEW_OPERATION, TSFeatureType.EXISTING_OPERATION], "Select a feature type");
    ...
    try {
        ...
        generateTSCode(featureClassName, snakeCaseFeatureName, targetDirectory, featureType);
